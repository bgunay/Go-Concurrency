...
// var arrivalRate = 100 //unused
var cutDuration = 1000 * time.Millisecond

//var timeOpen = 10 * time.Second //unused
...
func main() {
	...
	fmt.Printf("The shop is \"%#v\" has %d seats and %d barbers.\n", shop, shop.ShopCapacity, shop.NumberOfBarbers)
	// add barbers
